 <div class="list-group list-group-flush rounded-0">
     ...
     <a href="{{ route('dashboard') }}"
         class="list-group-item list-group-item-action {{ request()->routeIs('dashboard') ? 'fw-bold bg-light' : '' }}">
         <i class="bi bi-speedometer2 me-2"></i> داشبورد
     </a>

     <a href="{{ route('students.index') }}"
         class="list-group-item list-group-item-action {{ request()->routeIs('students.*') ? 'fw-bold bg-light' : '' }}">
         <i class="bi bi-person-vcard me-2"></i> دانش آموزان
     </a>

     <a href="{{ route('attendances.index') }}"
         class="list-group-item list-group-item-action {{ request()->routeIs('attendances.*') ? 'fw-bold bg-light' : '' }}">
         <i class="bi bi-calendar-check me-2"></i>حضور و غیاب</a>

     <a href="{{ route('student-violations.index') }}"
         class="list-group-item list-group-item-action {{ request()->routeIs('student-violations.*') ? 'fw-bold bg-light' : '' }}">
         <i class="bi bi-exclamation-circle me-2"></i>تخلفات</a>

     <a href="{{ route('classes.index') }}"
         class="list-group-item list-group-item-action {{ request()->routeIs('classes.*') ? 'fw-bold bg-light' : '' }}">
         <i class="bi bi-building me-2"></i>کلاس ها
     </a>

     <a href="{{ route('violation-titles.index') }}"
         class="list-group-item list-group-item-action {{ request()->routeIs('violation-titles.*') ? 'fw-bold bg-light' : '' }}">
         <i class="bi bi-sign-stop me-2"></i>عناوین انضباطی
     </a>

     <a href="{{ route('employees.index') }}"
         class="list-group-item list-group-item-action {{ request()->routeIs('employees.*') ? 'fw-bold bg-light' : '' }}">
